# ASOI_20230504_Steam
 	O Arquivo "steam_charts.csv" contém informações sobre popularidade dos jogos na plataforma Steam, estão contempladas as informações e divididas por ano e por mês. São mais de 83 mil registros de jogos.
...
as operações.
	**O código funciona normalmente, pode ser que o teste não seja possível se não houver a alteração ou criação do diretório selecionado
